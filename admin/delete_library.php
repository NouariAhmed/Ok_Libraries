    ...
    <h4 class="mb-3">حذف مكتبة</h4>
      <?php
            ...
            if (isset($_SESSION['delete_success']) && $_SESSION['delete_success'] === true) {
                ...
                header("Location: display_libraries.php?delete_success=1");
                exit;
            }
                ...
                $id = intval($_GET['id']);   
                    ...
                    if (isset($_POST['confirm'])) {
                        ...
                        mysqli_stmt_close($stmt);
                          ...
                          // Get libraries data to display	library name in the confirmation message
                            $sql = "SELECT library_name FROM libraries WHERE id = ?";
                        ...
                        <a href="display_libraries.php" class="btn btn-secondary">لا</a>
                        ';
                    }
            } 
